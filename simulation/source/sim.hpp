...
double simulate_param_set(int, input_params&, sim_data&, rates_static&, rates_dynamic&, con_levels&, con_levels&, mutant_data[], ofstream*, ofstream*, char**, ofstream*, ofstream*);
int simulate_section(int, input_params&, sim_data&, rates_static&, rates_dynamic[], con_levels&, con_levels&, mutant_data[], char**, double[]);
...
bool model(sim_data&, rates_static&, rates_dynamic[], con_levels&, con_levels&, mutant_data&, double[2]);
...
void split(sim_data&, rates_static& rs, rates_dynamic&, con_levels&, int, int);
void copy_records(sim_data& sd, con_levels& cl, int, int);
void update_rates(rates_static&, rates_dynamic&, int);
void protein_synthesis(sim_data&, array2D<double>&, con_levels&, st_context&, int[]);
...
double transcription_mespa(array2D<double>&, con_levels&, int, int, double, double, double, int);
double transcription_mespb(array2D<double>&, con_levels&, int, int, double, double, double);
void perturb_rates_all(rates_static&, rates_dynamic&);
void perturb_rates_column(sim_data&, rates_static&, rates_dynamic&, int);
