...
double simulate_param_set(int, input_params&, sim_data&, rates&, con_levels&, con_levels&, mutant_data[], ofstream*, ofstream*, char**, ofstream*, ofstream*, double[]);
int simulate_section(int, input_params&, sim_data&, rates&, con_levels&, con_levels&, mutant_data[], char**, double[],double[]);
...
double simulate_mutant(int, input_params&, sim_data&, rates&, con_levels&, con_levels&, mutant_data&, features&, char*, double[2],double[]);
bool model(sim_data&, rates&, con_levels&, con_levels&, mutant_data&, double[2], double[]);
...
void protein_synthesis(sim_data&, double**, con_levels&, st_context&, int[], mutant_data&,bool, bool,double[]);
void dim_int(di_args&, di_indices);
void con_protein_her(cp_args&, cph_indices,double);
...
void mRNA_synthesis(sim_data&, double**, con_levels&, st_context&, int[], mutant_data&, bool, bool, double[]);
...
double transcription_mespb(double**, con_levels&, int, int, double, double, double);
