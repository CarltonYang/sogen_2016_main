...
void mRNA_synthesis(sim_data&, double**, con_levels&, st_context&, int[], mutant_data&, bool, bool,double& ,double&);
void calc_neighbors_1d(sim_data&, int[], int, int, int);
void calc_neighbors_2d(sim_data&);
double transcription(double**, con_levels&, int, int, double, double, double, double&, double&);
double transcription_mespa(double**, con_levels&, int, int, double, double, double, int);
double transcription_mespb(double**, con_levels&, int, int, double, double, double, double&, double&);
