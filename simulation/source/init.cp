...
mutant_data* create_mutant_data (sim_data& sd, input_params& ip) {
    ...
    mds[MUTANT_WILDTYPE].num_conditions[SEC_POST_ONLY]=1;
    mds[MUTANT_WILDTYPE].cond_scores[SEC_POST_ONLY][0] = CW_A;
    ...
    */
    ...
    mds[MUTANT_DELTA].num_conditions[SEC_POST_ONLY]=2;
    mds[MUTANT_DELTA].cond_scores[SEC_POST_ONLY][0] = CW_A;
    mds[MUTANT_DELTA].cond_scores[SEC_POST_ONLY][1] = CW_A;
    mds[MUTANT_DELTA].calc_max_scores();
    mds[MUTANT_DELTA].print_con = CMMPESPB;
