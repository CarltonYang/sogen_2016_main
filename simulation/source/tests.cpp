...
double test_wildtype_post (mutant_data& md, features& wtfeat) {
    ...
    cout<<"WILD P0: "<<md.conds_passed[SEC_POST][0]<<endl;
    cout<<"WILD P1: "<<md.conds_passed[SEC_POST][1]<<endl;
...
double test_wildtype_ant (mutant_data& md, features& wtfeat) {
    ...
    cout<<"WILD 0: "<<md.conds_passed[SEC_ANT][0]<<endl;
    ...
    cout<<"WILD 10d: "<<md.conds_passed[SEC_ANT][7]<<"; "<<md.feat.sync_score_ant[2]<<endl;
    return
...
double test_delta_mutant_post (mutant_data& md, features& wtfeat) {
    ...
    cout<<"DELTA 0: "<<md.conds_passed[SEC_POST][0]<<"; "<<"IMH1 period: "<<md.feat.period_post<< " "<< wtfeat.period_post<< "  "<<md.feat.period_post / wtfeat.period_post <<endl;
...
double test_delta_mutant_ant (mutant_data& md, features& wtfeat) {
    ...
    cout<<"DELTA 1: "<<md.conds_passed[SEC_ANT][0]<<"; "<< md.feat.sync_score_ant[IMH1]<<endl;
    ...
    cout<<"DELTA 2: "<<md.conds_passed[SEC_ANT][1]<<"; "<<md.feat.amplitude_ant_time[IMH1][0]<< " " <<wtfeat.amplitude_ant_time[IMH1][0] <<" "<<md.feat.amplitude_ant_time[IMH1][0] / wtfeat.amplitude_ant_time[IMH1][0] <<endl;
    ...
    cout<<"DELTA 3: "<<md.conds_passed[SEC_ANT][2]<<"; mespa amp: "<< md.feat.amplitude_ant_time[IMDELTA][0]<<"; mespa amp wt: "<< wtfeat.amplitude_ant_time[IMDELTA][0]<<"; mespa rastio: "<<md.feat.amplitude_ant_time[IMDELTA][0] / wtfeat.amplitude_ant_time[IMDELTA][0]<<endl;
    
    

    md.conds_passed[SEC_ANT][3]= md.feat.sync_score_ant[IMMESPB] <= 0.7 ? 1 : (1- (md.feat.sync_score_ant[IMMESPB]-.7));// deltac.4.
    cout<<"DELTA 4: "<<md.conds_passed[SEC_ANT][3]<<"; "<<"mespb sync: "<< md.feat.sync_score_ant[IMMESPB]<<endl;
...
double test_DAPT_mutant_ant (mutant_data& md, features& wtfeat) {
    ...
    cout<<"DAPT 3: " <<md.conds_passed[SEC_ANT][2]<<"; "<<md.feat.amplitude_ant_time[IMMESPA][2]<<" "<< wtfeat.amplitude_ant_time[IMMESPA][2]<<" "<<md.feat.amplitude_ant_time[IMMESPA][2] / wtfeat.amplitude_ant_time[IMMESPA][2]<<endl;

    md.conds_passed[SEC_ANT][3]= md.feat.sync_score_ant[IMMESPB] <= .7 ? 1 : (1- (md.feat.sync_score_ant[IMMESPB]-.7));
    cout<<"DAPT 4: "<<  md.conds_passed[SEC_ANT][3]<<"; "<<md.feat.sync_score_ant[IMMESPB]<<endl;
...
double test_her1over_mutant_ant (mutant_data& md, features& wtfeat) {
    ...
    cout<<"1OVER 1: "<<md.conds_passed[SEC_ANT][0]<<"; "<< md.feat.amplitude_ant_time[IMH1][1]<<", "<<wtfeat.amplitude_ant_time[IMH1][1]<<" "<<md.feat.amplitude_ant_time[IMH1][1] / wtfeat.amplitude_ant_time[IMH1][1]<<endl;
    ...
    cout<<"1OVER 2: "<<md.conds_passed[SEC_ANT][1]<<"; "<< md.feat.amplitude_ant_time[IMDELTA][1]<<", "<<wtfeat.amplitude_ant_time[IMDELTA][1]<<" "<<md.feat.amplitude_ant_time[IMDELTA][1] / wtfeat.amplitude_ant_time[IMDELTA][1]<<endl;
    ...
    cout<<"1OVER 3: "<<md.conds_passed[SEC_ANT][2]<<"; "<< md.feat.amplitude_ant_time[IMMESPA][1]<<", "<<wtfeat.amplitude_ant_time[IMMESPA][1]<<" "<<md.feat.amplitude_ant_time[IMMESPA][1] / wtfeat.amplitude_ant_time[IMMESPA][1]<<endl;
    
    md.conds_passed[SEC_ANT][3]= (md.feat.sync_score_ant[IMMESPB]) <= 0.7 ? 1 : (1- (md.feat.sync_score_ant[IMMESPB]-.7));
    cout<<"1OVER 4: "<<md.conds_passed[SEC_ANT][3]<<"; "<<md.feat.sync_score_ant[IMMESPB]<<endl;
