...
void fill_perturbations(rates_static&, char*);
void fill_gradients(rates_static&, char*);
void calc_max_delay_size(input_params&, sim_data&, rates_static&, double**);
...
mutant_data* create_mutant_data(sim_data&, input_params&, rates_static&);
